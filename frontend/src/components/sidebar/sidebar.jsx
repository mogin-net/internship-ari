        ...
        <nav className="px-4 flex-1">
          <ul className="space-y-1">
            ...
            <li>
              ...
              >
                <span
                  className={`text-[9px] ${location.pathname === "/home" ? "text-amber-500/70" : "text-white/20 group-hover:text-amber-500/70"}`}
                >
                  01
                </span>
                <span
                  className={`text-[11px] uppercase tracking-[0.12em] transition-colors ${location.pathname === "/home" ? "text-amber-500" : "text-white/50 group-hover:text-white"}`}
                >
                  Home(Alpha)
                </span>
              </a>
            ...
            <li>
              ...
              >
                <span
                  className={`text-[9px] ${location.pathname === "/news" ? "text-amber-500/70" : "text-white/20 group-hover:text-amber-500/70"}`}
                >
                  02
                </span>
                <span
                  className={`text-[11px] uppercase tracking-[0.12em] transition-colors ${location.pathname === "/news" ? "text-amber-500" : "text-white/50 group-hover:text-white"}`}
                >
                  News(Alpha)
                </span>
              </a>
            ...
            <li>
              ...
              >
                <span
                  className={`text-[9px] ${location.pathname === "/characters" ? "text-amber-500/70" : "text-white/20 group-hover:text-amber-500/70"}`}
                >
                  03
                </span>
                <span
                  className={`text-[11px] uppercase tracking-[0.12em] transition-colors ${location.pathname === "/characters" ? "text-amber-500" : "text-white/50 group-hover:text-white"}`}
                >
                  Characters(Alpha)
                </span>
              </a>
            ...
            <li>
              ...
              >
                <span
                  className={`text-[9px] ${location.pathname === "/lore" ? "text-amber-500/70" : "text-white/20 group-hover:text-amber-500/70"}`}
                >
                  04
                </span>
                <span
            ...
            <li>
              ...
              >
                <span
                  className={`text-[9px] ${location.pathname === "/contents" ? "text-amber-500/70" : "text-white/20 group-hover:text-amber-500/70"}`}
                >
                  05
                </span>
                <span
